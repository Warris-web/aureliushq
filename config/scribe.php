...
return [
    ...
    [
        'match' => [
            // Only include real API routes
            'prefixes' => ['api/*','auth/*'], 
            'domains' => ['*'],
        ],

        // Include any additional routes explicitly if needed
        'include' => [
    ...
    'auth' => [
    'enabled' => true,      // Scribe knows your API requires auth
    'default' => true,      // Apply auth to all routes by default
    'in' => AuthIn::BEARER->value,
    'name' => 'Authorization',
    'use_value' => env('SCRIBE_AUTH_KEY'), // Put your API token in .env
