                        ...
                        <div class="col-12">
                            <div class="d-flex flex-wrap gap-3 small">
                                <div><strong>KYC:</strong>
                                    <span class="badge bg-success">{{ $totalCompletedKyc ?? 0 }} Completed</span>
                                    <span class="badge bg-warning">{{ $totalPendingKyc ?? 0 }} Pending</span>
                                </div>
                                <div><strong>Onboarding:</strong>
                                    <span class="badge bg-success">{{ $totalCompletedOnboarding ?? 0 }} Complete</span>
                                    <span class="badge bg-warning">{{ $totalPendingOnboarding ?? 0 }} Pending</span>
                                </div>
