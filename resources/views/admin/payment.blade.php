...
<div class="payment-records-wrapper">
    <div class="container">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem; flex-wrap:wrap; gap:1rem;">
            <div>
                <h2 style="font-size:1.875rem; font-weight:700; color:#111827; margin-bottom:0.25rem;">All Payment History</h2>
            ...
            <div style="overflow-x:auto;">
                <table id="payment-paymentTable" style="width:100%; border-collapse:collapse;">
                    <thead style="background:#1a1a1a; border-bottom:2px solid #ff8c00;">
                        <tr>
                            <th style="padding:0.875rem 1rem; text-align:left; font-weight:600; font-size:0.875rem; color:white;">User</th>
                    ...
                    <tbody id="payment-paymentTableBody">
                        ...
                        <tr class="payment-table-row" style="border-top:1px solid #f3f4f6; transition:background 0.15s;"
                            ...
                            <td style="padding:0.875rem 1rem; font-size:0.875rem; color:#111827; font-weight:600;">
                                <div class="user-info">
                                    <div class="user-details">
                                        <div class="user-name">{{ $payment->user->first_name }} {{ $payment->user->last_name }}</div>
