...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-dark mb-0">Manage Approved Orders</h3>
                        ...
                        <tbody>
                            @foreach($orders as $index => $order)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-dark text-white px-3">{{ $order->order_number }}</span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button 
                                            ...
                                            data-operational="{{ $order->operational_state ?? '' }}">
    ...
    @else
        <div class="text-center py-5">
            <h4 class="fw-bold text-secondary mt-3">No Delivered Orders Yet</h4>
    ...
    <form method="POST" action="{{ route('admin.update.order') }}" class="w-100">
        ...
        <div class="modal-content rounded-3 shadow">
            ...
            <div class="modal-body">
                ...
                <label for="operational_state" class="form-label fw-semibold mt-3">Select Operational State</label>
                <select class="form-select shadow-sm rounded-pill" name="operational_state" id="modal_operational">
                    <option value="">Select Operational State</option>
                    @foreach ($operational_states as $state)
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('.change-status-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('modal_operational').value = this.dataset.operational;
            modal.show();
        });
    });
    ...
    function setupPagination() {
        ...
        pagination.style.display = pageCount <= 1 ? 'none' : 'flex';
